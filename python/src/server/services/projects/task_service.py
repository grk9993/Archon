...
class TaskService:
    ...
    async def create_task(
        ...
        try:
            ...
            if task_order > 0:
                ...
                if existing_tasks_response.data:
                    ...
                    for existing_task in existing_tasks_response.data:
                        ...
                        self.database_client.table("archon_tasks").update({
            ...
            response = self.database_client.table("archon_tasks").insert(task_data).execute()
    ...
    def list_tasks(
        ...
        try:
            ...
            if exclude_large_fields:
                ...
                query = self.database_client.table("archon_tasks").select(
    ...
    def get_task(self, task_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            response = (
                self.database_client.table("archon_tasks").select("*").eq("id", task_id).execute()
            )
